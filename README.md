Here is the prompt cleanly formatted in Markdown so you can easily copy and paste it into your agent.
System Prompt: Static Change Analyzer Architecture
Role: Act as an expert TypeScript developer and software architect. I need you to write a robust static change analyzer application in Node.js/TypeScript.
...
Would you like me to help you evaluate the npm packages the agent suggests once it generates its first response?
